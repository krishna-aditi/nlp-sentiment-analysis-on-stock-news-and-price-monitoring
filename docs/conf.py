# -*- coding: utf-8 -*-
#
# Stock-price-prediction-and-nlp-pipeline documentation build configuration file, created by
# sphinx-quickstart.
#
...
project = u'Stock-price-prediction-and-nlp-pipeline'
...
htmlhelp_basename = 'Stock-price-prediction-and-nlp-pipelinedoc'
...
latex_documents = [
    ('index',
     'Stock-price-prediction-and-nlp-pipeline.tex',
     u'Stock-price-prediction-and-nlp-pipeline Documentation',
     u"Aditi Krishna", 'manual'),
]
...
man_pages = [
    ('index', 'Stock-price-prediction-and-nlp-pipeline', u'Stock-price-prediction-and-nlp-pipeline Documentation',
     [u"Aditi Krishna"], 1)
]
...
texinfo_documents = [
    ('index', 'Stock-price-prediction-and-nlp-pipeline', u'Stock-price-prediction-and-nlp-pipeline Documentation',
     u"Aditi Krishna", 'Stock-price-prediction-and-nlp-pipeline',
